...
<section class="content">
      <div class="row">
        <div class="col-xs-12">
            ...
            <!-- /.box-body -->
            @include('project_manager.layouts.overlay')
          </div>
          <!-- /.box -->
        </div>
        <!-- /.col -->
...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('project_manager.developers.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('project_manager.developers.index') }}",
	        ...
	        { "mData": "contact_number",sWidth: "10%",bSortable: false,},
	        {
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("project_manager.developers.edit", ":id") }}';
