...
<body class="hold-transition login-page" style="height: 80%; background-size: cover; background-image:url({{asset('assets/homepage.jpg')}})">
<div class="login-box">
  ...
  <div class="login-box-body">
    <form action="{{ route('project_manager.password.request') }}" method="post">
        <input type="hidden" name="token" value="{{ $token }}">
        @csrf
      <div class="form-group has-feedback">
        <input type="email" class="form-control" value="{{ $email ?? old('email') }}" name="email" placeholder="Email">
