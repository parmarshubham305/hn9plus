...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('project_manager.users.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('project_manager.users.index') }}",
			...
			},
	        {
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("project_manager.users.edit", ":id") }}';
