<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="@if(Request::segment(2) == 'seos') active @endif treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="@if(Request::segment(2) == 'seos' && Request::segment(3) == '') active @endif"><a href="{{ route('admin.seos.index') }}"><i class="fa fa-circle-o"></i> List </a></li>
                    <li class="@if(Request::segment(2) == 'seos' && Request::segment(3) == 'create') active @endif"><a href="{{ route('admin.seos.create') }}"><i class="fa fa-circle-o"></i> Create </a></li>
                </ul>
            </li>
        </ul>
    </section>
