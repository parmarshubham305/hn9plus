...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.seos.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.seos.index') }}",
	        ...
	        { "mData": "path",sWidth: "10%",bSortable: true,},
	        { "mData": "title",sWidth: "10%",bSortable: true,},
	        { "mData": "description",sWidth: "10%",bSortable: true,},
	        {
	            mData: null,
	            bSortable: false,
	            sWidth: "10%",
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("admin.seos.edit", ":id") }}';
