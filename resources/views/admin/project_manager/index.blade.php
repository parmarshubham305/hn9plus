...
{{ Html::script('backend/js/delete_script.js') }}
	...
	var type = "warning";
	var delete_path = "{{ URL::route('admin.project-managers.delete') }}";
	...
	$(function()
	{
	    var dataTable = $('#dataTable').dataTable({
	        ...
	        "sAjaxSource": "{{ URL::route('admin.project-managers.index') }}",
	        ...
	        { "mData": "email",sWidth: "10%",bSortable: true,},
	        {
	            ...
	            mRender: function(v, t, o) {
	                ...
	                var editUrl = '{{ route("admin.project-managers.edit", ":id") }}';
