...
class Chat extends Component
{
    ...
    {
        $chatIn = ChatUser::where('user_id', auth()->guard('developer')->user()->id)->where('user_type', 'Developer')->pluck('chat_id', 'chat_id')->toArray();
    ...
    public function SendMessage() {
        if(!empty($this->message)) {
            ...
            $obj->user_id = auth()->guard('developer')->user()->id;
            $obj->send_by = 'Developer';
    ...
    {
        return view('livewire.developer.chat');
    }
}
