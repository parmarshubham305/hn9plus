...
class SEOController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = SEO::select('id', 'path', 'title', 'description')
                ->whereRaw($where_str, $where_params);
                
            $data_count = SEO::select('id')
                ->whereRaw($where_str, $where_params)
                ->count();

            $columns = ['id', 'path', 'title', 'description'];
